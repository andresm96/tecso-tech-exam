...
public class Ejercicio4 {
	...
	public static void main(String[] args) {
		...
		/*
		 * Recibe lista1, cuenta la cantidad de numeros pares y los imprime en consola.
		 * Agrega los numeros impares a un nuevo arrayList e imprime esa lista en consola.
		 * Divide el largo de la lista a la mitad (numero 5), luego muestra el indice de la 
		 * posicion de ese numero (el indice es 2) en consola.
		 * Luego cuenta los numeros (en la variable c) de lista1 que sean mayores que el parametro "numero".
		 * Cualquiera sea el valor de c, imprime por consola "..."
		 */
		
		// EJERCICIO 4.2: corregir el metodo (Done)
		List<Integer> union = unionListas(lista1, lista2);
		System.out.println("union: " + union.toString());
		
		// EJERCICIO 4.3: implementar (Done)
		List<Integer> interseccion = interseccionListas(lista1, lista2);
		System.out.println("interseccion: " + interseccion.toString());
		
		// EJERCICIO 4.4: implementar (Done)
		List<Integer> orden1 = ordenaListaAscendente(lista1);
		System.out.println("orden asc: " + orden1);
		
		// EJERCICIO 4.5: implementar (Done)
		List<Integer> orden2 = ordenaListaDescendente(lista2);
		System.out.println("orden desc: " + orden2);

		// EJERCICIO 4.6: implementar (Done)
